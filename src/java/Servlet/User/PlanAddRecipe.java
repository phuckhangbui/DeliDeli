 ...
 * @author Daiisuke
 */
public class PlanAddRecipe extends HttpServlet {
...
//            System.out.println("end_time recieved - " + end_time);
            ...
            if (date_id != 0 && plan_id != 0 && recipe_id != 0 && start_timeStr != null && end_timeStr != null) {
                result = MealDAO.addMealById(date_id, recipe_id, start_time, end_time);
