                ...
                <div class="row navigation-bar-first">
                    ...
                    <div class="search-bar col-md-7">
                        <form action="MainController" method="post">
                            <button type="submit" name="action"
                                    value="search"><img src="assets/search2.svg"
                                                alt=""></button>
                    ...
                    <div class="notification col-md-1">
                        <div class="dropdown-notification">
                            <button class="dropbtn-notification"
...
// Close dropdown content when clicking outside, unless a modal is open
        ...
        %>
        <!-- Modal -->
        <div class="modal fade" id="<%= notification.getId()%>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
