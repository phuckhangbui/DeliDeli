              ...
              integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">-->
                                            ...
                                            <body>
                                                ...
                                                <%@include file="header.jsp" %>
                                                    ...
                                                    <div class="recommendation-2">
                                                        <div class="container">
                                                            <div class="row">
                                                                <% LocalTime currentTime=LocalTime.now(); String time=""
                        ...
                        if (currentTime.isAfter(MorningStartTime) && currentTime.isBefore(AfternoonStartTime)) {
                            recommendList = NavigationBarUtils.searchRecipes(" Breakfast", "Category" );
                                                                    ...
                                                                    (currentTime.isAfter(NightStartTime) ||
                                                            ...
                                                            <div class="row recommendation-content">
                                                                <% if (recommendList !=null && recommendList.size() !=0)
                                                                    ...
                                                                    <% } } else { System.out.println("[TIME BASED
                                                                        RECIPE]: The recipe recieved is null"); } %>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="recommendation-3">
                                                        <div class="container">
                                                            <% ArrayList<RecipeDTO> suggestionRecipeList;
                                                                ...
                                                                String selectedSuggestion = (String)
                                                                session.getAttribute("selectedSuggestion");
